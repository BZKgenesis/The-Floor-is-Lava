...
public class KitData {
    ...
    public void applyToPlayerNoClear(Player player) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(TheFloorIsLava.getInstance(), () -> player.getInventory().setArmorContents(armor), 2L);
    ...
    public void startPotionEffectTask() {
        ...
        if (potionEffectTaskRunnable != null) {
            this.potionEffectTaskInstance = Bukkit.getScheduler().runTaskTimer(TheFloorIsLava.getInstance(), potionEffectTaskRunnable, 0L, 20L);
        }
    }
