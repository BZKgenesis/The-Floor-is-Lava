...
public class GuiUtils {
    ...
    public static ItemStack createItem(Material mat, Component name, String id, String customModelData) {
        ...
        if (id != null)
            m.getPersistentDataContainer().set(new NamespacedKey(TheFloorIsLavaManager.getInstance(), "buttonId"), PersistentDataType.STRING, id);
        it.setItemMeta(m);
        return it;
    }
    ...
    public static ItemStack createBackItem(Player p) {
        ...
        ItemMeta m = it.getItemMeta();
        m.getPersistentDataContainer().set(new NamespacedKey(TheFloorIsLavaManager.getInstance(), "buttonId"), PersistentDataType.STRING, "back");
    ...
    public static String getButtonId(ItemStack stack) {
        if (stack == null) return null;
        return stack.getPersistentDataContainer().get(new NamespacedKey(TheFloorIsLavaManager.getInstance(), "buttonId"), PersistentDataType.STRING);
    }
